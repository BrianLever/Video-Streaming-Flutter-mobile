...
class SaveSerieOption extends StatefulWidget {
...
class _SaveVideoOptionState extends State<SaveSerieOption> {
  bool _saved;
...
class SaveSerieDialog extends StatelessWidget {
  final Playlist video;

  SaveSerieDialog({@required this.video});
  @override
  Widget build(BuildContext context) {
    return Column(
