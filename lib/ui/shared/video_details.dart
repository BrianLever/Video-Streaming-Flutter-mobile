import 'package:americonictv_mobile/ui/shared/serieslist_view/Serieslist_page.dart';
  ...
  Widget build(BuildContext context) {
    return Padding(
      ...
      child: GestureDetector(
        ...
        onTap: ()  {
              if(widget.data.playlists!=null) {
                 Navigator.of(context).push(MaterialPageRoute(
                 builder:(BuildContext context) =>
                 SerieslistDisplay(response: widget.data.playlists)));
              }
             else{
